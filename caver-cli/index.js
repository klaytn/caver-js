...
console.log(
  chalk.yellow(
    figlet.textSync('Onit', { horizontalLayout: 'full', font: 'Dancing Font' })
  )
)
        ...
        case '2)Add':
          inquirer.prompt([
            ...
            },
            {
              ...
              .then((answers) => {
                const inputFormattersQuestion = _.range(answers.params)
                  .map((_, idx) => ({
                    type: 'list',
                ...
                return Promise.all([
                  answers,
                  inquirer.prompt([...inputFormattersQuestion, {
                    type: 'list',
