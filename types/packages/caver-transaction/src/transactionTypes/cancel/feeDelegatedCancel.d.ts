...
export class FeeDelegatedCancel extends AbstractFeeDelegatedTransaction {
    static create(createTxObj: string | CreateTransactionObject, klaytnCall?: KlaytnCall): FeeDelegatedCancel
    static decode(rlpEncoded: string, klaytnCall?: KlaytnCall): FeeDelegatedCancel
