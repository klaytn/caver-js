...
export class DeprecatedKlayRPC {
    ...
    getHeader: RpcCallToMethod['klay_getHeader']
    ...
    getRewardsByNumber: RpcCallToMethod['klay_getRewardsByNumber']
    getRewardsByHash: RpcCallToMethod['klay_getRewardsByHash']
    ...
    createAccessList: RpcCallToMethod['klay_createAccessList']
    getDecodedAnchoringTransactionByHash: RpcCallToMethod['klay_getDecodedAnchoringTransactionByHash']
    getFeeHistory: RpcCallToMethod['klay_feeHistory']
    getMaxPriorityFeePerGas: RpcCallToMethod['klay_maxPriorityFeePerGas']
    ...
    sendTransactionAsFeePayer: RpcCallToMethod['klay_sendTransactionAsFeePayer']
    signTransaction: RpcCallToMethod['klay_signTransaction']
    signTransactionAsFeePayer: RpcCallToMethod['klay_signTransactionAsFeePayer']
