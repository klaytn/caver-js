...
export namespace ACCOUNT_KEY_TAG {
    ...
    const ACCOUNT_KEY_LEGACY_TAG: string
    const ACCOUNT_KEY_PUBLIC_TAG: string
    const ACCOUNT_KEY_FAIL_TAG: string
    const ACCOUNT_KEY_WEIGHTED_MULTISIG_TAG: string
    const ACCOUNT_KEY_ROLE_BASED_TAG: string
}
