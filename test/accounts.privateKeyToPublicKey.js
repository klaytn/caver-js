...
describe('caver.klay.accounts.privateKeyToPublicKey', () => {
    it('CAVERJS-UNIT-WALLET-015 : Should return publicKey with valid argument', () => {
        ...
        const pubKey = '0xb154904c7453522361fd19da5e830b47c8e5a4724ac94870a179c4da5b272b04b7e4c087e99dd50ce2c4fd6e1cb74b92f9b6a364e323d1d210851ad00de47281'
    ...
    it('CAVERJS-UNIT-WALLET-016 : Should return publicKey with klaytnWalletKey format', () => {
        const privateKey = '0x600dfc414fe433881f6606c24955e4143df9d203ccb3e335efe970a4ad017d040x000xee135d0b57c7ff81b198763cfd7c43f03a5f7622'

        const pubKey = '0x813b6bdfccfeab122aaae598b6650c6ccd0a6455858ce9f02f27abf335a7de91257fc8f169d19058e448c39caca57195eb767c0da43ae60c6be64dc51ab6e643'
    ...
    it('CAVERJS-UNIT-WALLET-018 : Should return error with not hex argument', () => {
        expect(() => caver.klay.accounts.privateKeyToPublicKey('0xf5f83691fa6619396e1b8810b49cec1de624a07c7a7ef36cf860479282ff7xyz')).to.throw()
    })
})
