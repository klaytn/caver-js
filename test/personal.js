...
describe('Personal RPC test', () => {
    ...
    it('sendAccountUpdate should send account update transaction using account in node.', async () => {
        ...
        receipt = await caver.klay.personal.sendAccountUpdate({
            from: testAccount.address,
            gas: 9000000,
            key: '0x04f86f03f86ce301a103501406a8a3d82927868980d16ca16d3efe768a2ffb44b4a03632f8265e0331fce302a10205274ea06b36a35f123400d3d95f3b460aa2ac069749582fd7322f1ff36c063be303a102fcde89952a548fc0f6e32183eef6738eeea290d6d01af28bc03fbb6ed4f66d2d',
        }, passphrase)
        expect(receipt).not.to.be.null
