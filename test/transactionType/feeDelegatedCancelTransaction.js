...
describe('FEE_DELEGATED_CANCEL transaction', async () => {
    let cancelObject
    ...
    it('CAVERJS-UNIT-TX-526 : If transaction object missing from, sendTransaction should throw error', async () => {
        const tx = { ...cancelObject }
        delete tx.from
    ...
    it('CAVERJS-UNIT-TX-527 : If transaction object has unnecessary to field, sendTransaction should throw error', async () => {
        const tx = { to: testAccount.address, ...cancelObject }

        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"to" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-528 : If transaction object has unnecessary value field, sendTransaction should throw error', async () => {
        const tx = { value: 1, ...cancelObject }

        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"value" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-529 : If transaction object missing gas and gasLimit, sendTransaction should throw error', async () => {
        const tx = { ...cancelObject }
        delete tx.gas
    ...
    it('CAVERJS-UNIT-TX-530 : If transaction object has unnecessary data field, sendTransaction should throw error', async () => {
        const tx = { data: '0x68656c6c6f', ...cancelObject }

        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"data" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-531 : If transaction object missing feePayer, should throw error', async () => {
        ...
        ).to.throws('The "feePayer" field must be defined for signing with feePayer!')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-533 : If transaction object has unnecessary feeRatio field, sendTransaction should throw error', async () => {
        const tx = { feeRatio: 10, ...cancelObject }

        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"feeRatio" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-534 : If transaction object has unnecessary publicKey field, sendTransaction should throw error', async () => {
        const tx = {
            publicKey:
                '0x006dc19d50bbc8a8e4b0f26c0dd3e78978f5f691a6161c41e3b0e4d1aa2d60fad62f37912b59f484b2e05bd3c9c3b4d93b0ca570d6d4421eee544e7da99e9de4',
            ...cancelObject,
        ...
        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"publicKey" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-535 : If transaction object has unnecessary multisig field, sendTransaction should throw error', async () => {
        const multisig = {
            threshold: 3,
            keys: [
                {
        ...
        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"multisig" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-536 : If transaction object has unnecessary roleTransactionKey field, sendTransaction should throw error', async () => {
        const roleTransactionKey = {
            publicKey:
                '0xf4fa613bf44e5fa7505ad196605a1f32d3eb695f41916fb50f6c3ce65d345a059ebc2dc69629808c2a7c98eb0f2daad68f0b39f0a49141318fe59b777e6b8d1c',
        }
    ...
    it('CAVERJS-UNIT-TX-537 : If transaction object has unnecessary roleAccountUpdateKey field, sendTransaction should throw error', async () => {
        const roleAccountUpdateKey = {
            publicKey:
                '0xf4fa613bf44e5fa7505ad196605a1f32d3eb695f41916fb50f6c3ce65d345a059ebc2dc69629808c2a7c98eb0f2daad68f0b39f0a49141318fe59b777e6b8d1c',
        }
    ...
    it('CAVERJS-UNIT-TX-538 : If transaction object has unnecessary roleFeePayerKey field, sendTransaction should throw error', async () => {
        const roleFeePayerKey = {
            publicKey:
                '0xf4fa613bf44e5fa7505ad196605a1f32d3eb695f41916fb50f6c3ce65d345a059ebc2dc69629808c2a7c98eb0f2daad68f0b39f0a49141318fe59b777e6b8d1c',
        }
    ...
    it('CAVERJS-UNIT-TX-539 : If transaction object has unnecessary failKey field, sendTransaction should throw error', async () => {
        const tx = { failKey: true, ...cancelObject }

        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"failKey" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-540 : If transaction object has unnecessary codeFormat field, sendTransaction should throw error', async () => {
        const tx = { codeFormat: 'EVM', ...cancelObject }

        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"codeFormat" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-541 : If transaction object has unnecessary legacyKey field, sendTransaction should throw error', async () => {
        const tx = { legacyKey: true, ...cancelObject }

        await expect(caver.klay.sendTransaction(tx)).to.be.rejectedWith('"legacyKey" cannot be used with FEE_DELEGATED_CANCEL transaction')
    }).timeout(200000)
    ...
    it('CAVERJS-UNIT-TX-607: If transaction object has invalid from, sendTransaction should throw error', async () => {
        const tx = { ...cancelObject }
        tx.from = 'invalidAddress'
    ...
    it('CAVERJS-UNIT-TX-608: If transaction object missing feePayer, signTransaction should throw error', async () => {
        ...
        const tx = { feePayerSignatures, ...cancelObject }
    ...
    it('CAVERJS-UNIT-TX-609: If transaction object missing feePayer, signTransaction should throw error', async () => {
        ...
        const tx = { feePayer: invalidFeePayer, feePayerSignatures, ...cancelObject }
