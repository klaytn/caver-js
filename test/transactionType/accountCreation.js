...
describe('ACCOUNT_CREATION transaction', () => {
  ...
  const pubKey3 = '0x6d545db2dcba5a9f4201e4199ac5308b3e4f31033a9be3ebc0944e2d2fb0b7622f903f53e0ea5d0e20ce748a3da08052e6533107acaad0c14aba8c54f40154a3'
  ...
  it('CAVERJS-UNIT-TX-114 : If transaction object has publicKey, create account with publicKey', async () => {
    ...
    await caver.klay.sendTransaction(tx)
      .then(async()=>{
        await caver.klay.getAccountKey(tx.to)
          .then((key)=>{
  ...
  it('CAVERJS-UNIT-TX-125 : If transaction object has roleAccountUpdateKey and roleTransactionKey, create account with roleTransactionKey and roleAccountUpdateKey', async () => {
    const tx = Object.assign({roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}}, accountCreationObject)

    var result
    await caver.klay.sendTransaction(tx)
      .then(async(receipt)=>{
        expect(receipt.to).to.equals(tx.to)
        await caver.klay.getAccountKey(receipt.to)
          .then((key)=>{
            const expectedXY_transaction = caver.utils.xyPointFromPublicKey(pubKey1)
            const expectedXY_update = caver.utils.xyPointFromPublicKey(pubKey2)
            expect(key.keyType).to.equals(5)
            expect(key.key.length).to.equals(2)
            expect(key.key[0].keyType).to.equals(2)
            expect(key.key[0].key["x"]).to.equals(expectedXY_transaction[0])
            expect(key.key[0].key["y"]).to.equals(expectedXY_transaction[1])
            expect(key.key[1].keyType).to.equals(2)
            expect(key.key[1].key["x"]).to.equals(expectedXY_update[0])
            expect(key.key[1].key["y"]).to.equals(expectedXY_update[1])
            result = true
          }).catch(result = false)
      })
      .catch(result = false)
  ...
  it('CAVERJS-UNIT-TX-129 : If transaction object has roleAccountUpdateKey, roleTransactionKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({roleAccountUpdateKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, publicKey : pubKey1}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-130 : If transaction object has roleAccountUpdateKey, roleTransactionKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({roleAccountUpdateKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-131 : If transaction object has roleAccountUpdateKey, roleTransactionKey, multisig and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({roleAccountUpdateKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, multisig, publicKey : pubKey1}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-133 : If transaction object has roleFeePayerKey and roleTransactionKey, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-134 : If transaction object has roleFeePayerKey and roleAccountUpdateKey, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-135 : If transaction object has roleFeePayerKey, roleTransactionKey and roleAccountUpdateKey, create account with roleTransactionKey, roleAccountUpdateKey and roleFeePayerKey', async () => {
    const tx = Object.assign({roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, roleFeePayerKey: {publicKey:pubKey3}}, accountCreationObject)
      ...
      .then(async(receipt)=>{
        ...
        await caver.klay.getAccountKey(receipt.to)
          .then((key)=>{
            const expectedXY_transaction = caver.utils.xyPointFromPublicKey(pubKey1)
            const expectedXY_update = caver.utils.xyPointFromPublicKey(pubKey2)
            const expectedXY_fee = caver.utils.xyPointFromPublicKey(pubKey3)
            expect(key.keyType).to.equals(5)
            ...
            expect(key.key[2].key["x"]).to.equals(expectedXY_fee[0])
            expect(key.key[2].key["y"]).to.equals(expectedXY_fee[1])
            result = true
          }).catch(result = false)
      })
      .catch(result = false)
  ...
  it('CAVERJS-UNIT-TX-139 : If transaction object has roleFeePayerKey, roleTransactionKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, publicKey: pubKey3}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-140 : If transaction object has roleFeePayerKey, roleTransactionKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-141 : If transaction object has roleFeePayerKey, roleTransactionKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, publicKey: pubKey3, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-142 : If transaction object has roleFeePayerKey, roleAccountUpdateKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, publicKey: pubKey3}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-143 : If transaction object has roleFeePayerKey, roleAccountUpdateKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-144 : If transaction object has roleFeePayerKey, roleAccountUpdateKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, publicKey: pubKey3, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-145 : If transaction object has roleFeePayerKey, roleTransactionKey, roleAccountUpdateKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, roleAccountUpdateKey: {publicKey:pubKey3}, publicKey: pubKey4}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-146 : If transaction object has roleFeePayerKey, roleTransactionKey, roleAccountUpdateKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, roleAccountUpdateKey: {publicKey:pubKey3}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-147 : If transaction object has roleFeePayerKey, roleTransactionKey, roleAccountUpdateKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({roleFeePayerKey: {publicKey:pubKey1}, roleTransactionKey: {publicKey:pubKey2}, roleAccountUpdateKey: {publicKey:pubKey3}, publicKey: pubKey4, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-155 : If transaction object has failKey, roleTransactionKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, publicKey: pubKey1, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-159 : If transaction object has failKey, roleAccountUpdateKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleAccountUpdateKey: {publicKey:pubKey1}, publicKey: pubKey1, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-163 : If transaction object has failKey, roleFeePayerKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleFeePayerKey: {publicKey:pubKey1}, publicKey: pubKey1, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-164 : If transaction object has failKey, roleTransactionKey, roleAccountUpdateKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, publicKey: pubKey1}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-165 : If transaction object has failKey, roleTransactionKey, roleAccountUpdateKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-166 : If transaction object has failKey, roleTransactionKey, roleAccountUpdateKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, publicKey: pubKey1, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-167 : If transaction object has failKey, roleTransactionKey, roleFeePayerKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleFeePayerKey: {publicKey:pubKey2}, publicKey: pubKey1}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-168 : If transaction object has failKey, roleTransactionKey, roleFeePayerKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleFeePayerKey: {publicKey:pubKey2}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-169 : If transaction object has failKey, roleTransactionKey, roleFeePayerKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleFeePayerKey: {publicKey:pubKey2}, publicKey: pubKey1, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-170 : If transaction object has failKey, roleAccountUpdateKey, roleFeePayerKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleAccountUpdateKey: {publicKey:pubKey2}, roleFeePayerKey: {publicKey:pubKey3}, publicKey: pubKey1}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-171 : If transaction object has failKey, roleAccountUpdateKey, roleFeePayerKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleAccountUpdateKey: {publicKey:pubKey2}, roleFeePayerKey: {publicKey:pubKey3}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-172 : If transaction object has failKey, roleAccountUpdateKey, roleFeePayerKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleAccountUpdateKey: {publicKey:pubKey2}, roleFeePayerKey: {publicKey:pubKey3}, publicKey: pubKey1, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-173 : If transaction object has failKey, roleTransactionKey, roleAccountUpdateKey, roleFeePayerKey and publicKey, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, roleFeePayerKey: {publicKey:pubKey3}, publicKey: pubKey1}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-174 : If transaction object has failKey, roleTransactionKey, roleAccountUpdateKey, roleFeePayerKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, roleFeePayerKey: {publicKey:pubKey3}, multisig}, accountCreationObject)
  ...
  it('CAVERJS-UNIT-TX-175 : If transaction object has failKey, roleTransactionKey, roleAccountUpdateKey, roleFeePayerKey, publicKey and multisig, signTransaction should throw error', async () => {
    const tx = Object.assign({failKey: true, roleTransactionKey: {publicKey:pubKey1}, roleAccountUpdateKey: {publicKey:pubKey2}, roleFeePayerKey: {publicKey:pubKey3}, publicKey: pubKey1, multisig}, accountCreationObject)
