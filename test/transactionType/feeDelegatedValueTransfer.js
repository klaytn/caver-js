...
describe('FEE_DELEGATED_VALUE_TRANSFER transaction', async () => {
    let feeDelegatedValueTransferObject
    ...
    it('If transaction object has all essential value, sendTransaction should not return error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-035 : If transaction object missing from, sendTransaction should throw error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
        delete tx.from
    ...
    it('CAVERJS-UNIT-TX-036 : If transaction object missing to, sendTransaction should throw error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
        delete tx.to
    ...
    it('CAVERJS-UNIT-TX-037 : If transaction object missing value, sendTransaction should throw error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
        delete tx.value
    ...
    it('CAVERJS-UNIT-TX-038 : If transaction object missing gas and gasLimit, sendTransaction should throw error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
        delete tx.gas
    ...
    it('CAVERJS-UNIT-TX-039 : If transaction object missing feePayer, signTransaction should throw error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-040 : If transaction object missing senderRawTransaction, signTransaction should throw error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-041 : If transaction object has unnecessary feeRatio field, signTransaction should throw error', async () => {
        const tx = { feeRatio: 20, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-041 : If transaction object has unnecessary feeRatio field, sendTransaction should throw error', async () => {
        const tx = { feeRatio: 20, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-042 : If transaction object has unnecessary publicKey field, sendTransaction should throw error', async () => {
        const tx = {
            publicKey:
                '0x006dc19d50bbc8a8e4b0f26c0dd3e78978f5f691a6161c41e3b0e4d1aa2d60fad62f37912b59f484b2e05bd3c9c3b4d93b0ca570d6d4421eee544e7da99e9de4',
            ...feeDelegatedValueTransferObject,
    ...
    it('CAVERJS-UNIT-TX-043 : If transaction object has unnecessary multisig field, signTransaction should throw error', async () => {
        ...
        const tx = { multisig, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-043 : If transaction object has unnecessary multisig field, sendTransaction should throw error', async () => {
        const multisig = {
            threshold: 3,
            keys: [
                {
    ...
    it('CAVERJS-UNIT-TX-044 : If transaction object has unnecessary roleTransactionKey field, signTransaction should throw error', async () => {
        ...
        const tx = { roleTransactionKey, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-044 : If transaction object has unnecessary roleTransactionKey field, sendTransaction should throw error', async () => {
        const roleTransactionKey = {
            publicKey:
                '0xf4fa613bf44e5fa7505ad196605a1f32d3eb695f41916fb50f6c3ce65d345a059ebc2dc69629808c2a7c98eb0f2daad68f0b39f0a49141318fe59b777e6b8d1c',
        }
    ...
    it('CAVERJS-UNIT-TX-045 : If transaction object has unnecessary roleAccountUpdateKey field, signTransaction should throw error', async () => {
        ...
        const tx = { roleAccountUpdateKey, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-045 : If transaction object has unnecessary roleAccountUpdateKey field, sendTransaction should throw error', async () => {
        const roleAccountUpdateKey = {
            publicKey:
                '0xf4fa613bf44e5fa7505ad196605a1f32d3eb695f41916fb50f6c3ce65d345a059ebc2dc69629808c2a7c98eb0f2daad68f0b39f0a49141318fe59b777e6b8d1c',
        }
    ...
    it('CAVERJS-UNIT-TX-046 : If transaction object has unnecessary roleFeePayerKey field, signTransaction should throw error', async () => {
        ...
        const tx = { roleFeePayerKey, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-046 : If transaction object has unnecessary roleFeePayerKey field, sendTransaction should throw error', async () => {
        const roleFeePayerKey = {
            publicKey:
                '0xf4fa613bf44e5fa7505ad196605a1f32d3eb695f41916fb50f6c3ce65d345a059ebc2dc69629808c2a7c98eb0f2daad68f0b39f0a49141318fe59b777e6b8d1c',
        }
    ...
    it('CAVERJS-UNIT-TX-047 : If transaction object has unnecessary failKey field, signTransaction should throw error', async () => {
        const tx = { failKey: true, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-047 : If transaction object has unnecessary failKey field, sendTransaction should throw error', async () => {
        const tx = { failKey: true, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-048 : If transaction object has unnecessary codeFormat field, signTransaction should throw error', async () => {
        const tx = { codeFormat: 'EVM', ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-048 : If transaction object has unnecessary codeFormat field, sendTransaction should throw error', async () => {
        const tx = { codeFormat: 'EVM', ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-049 : If transaction object has unnecessary data field, signTransaction should throw error', async () => {
        ...
        const tx = { data, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-049 : If transaction object has unnecessary data field, sendTransaction should throw error', async () => {
        const data =
            ''
        const tx = { data, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-639: If transaction object has invalid from, sendTransaction should throw error', async () => {
        const tx = { ...feeDelegatedValueTransferObject }
        tx.from = 'invalidAddress'
    ...
    it('CAVERJS-UNIT-TX-640: If transaction object missing feePayer, signTransaction should throw error', async () => {
        ...
        const tx = { feePayerSignatures, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-641: If transaction object missing feePayer, signTransaction should throw error', async () => {
        ...
        const tx = { feePayer: invalidFeePayer, feePayerSignatures, ...feeDelegatedValueTransferObject }
    ...
    it('CAVERJS-UNIT-TX-642: If transaction object has unnecessary feePayerSignatures, sendTransaction should throw error', async () => {
        const invalidTo = 'invalid'
        const tx = { ...feeDelegatedValueTransferObject }
        tx.to = invalidTo
