...
describe('get transaction from block', () => {
  ...
  it('should throw an error with invalid index', () => {
    ...
    expect(() => caver.klay.getTransactionFromBlock('latest', invalidIndex)).to.throw('Given input "',invalidIndex,'" is not a number.')
  }).timeout(100000)

  it('should throw an error with invalid block number', () => {
    const invalidBlockNumber = 'invalidBlockNumber'
    expect(() => caver.klay.getTransactionFromBlock(invalidBlockNumber, 0)).to.throw('Given input "', invalidBlockNumber, '"is not a number.')
  }).timeout(100000)
