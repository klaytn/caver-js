...
describe('TxTypeFeeDelegatedSmartContractExecution', () => {
    ...
    context('create feeDelegatedSmartContractExecution instance', () => {
        it('CAVERJS-UNIT-TRANSACTIONFD-297: If feeDelegatedSmartContractExecution not define from, return error', () => {
            ...
            expect(() => new caver.transaction.feeDelegatedSmartContractExecution(transactionObj)).to.throw(expectedError)
        })
    ...
    context('feeDelegatedSmartContractExecution.getRLPEncoding', () => {
        it('CAVERJS-UNIT-TRANSACTIONFD-306: Returns RLP-encoded string', () => {
            const tx = new caver.transaction.feeDelegatedSmartContractExecution(txWithExpectedValues.tx)
    ...
    context('feeDelegatedSmartContractExecution.signWithKey', () => {
        ...
        it('CAVERJS-UNIT-TRANSACTIONFD-314: input: keyring, custom hasher. should throw error.', async () => {
    ...
    context('feeDelegatedSmartContractExecution.signFeePayerWithKey', () => {
        const txHash = '0xe9a11d9ef95fb437f75d07ce768d43e74f158dd54b106e7d3746ce29d545b550'
        ...
        it('CAVERJS-UNIT-TRANSACTIONFD-323: input: keyring, custom hasher. should throw error.', async () => {
            const hashForCustomHasher = '0x9e4b4835f6ea5ce55bd1037fe92040dd070af6154aefc30d32c65364a1123cae'
            const customHasher = () => hashForCustomHasher
    ...
    context('feeDelegatedSmartContractExecution.signWithKeys', () => {
        const txHash = '0xe9a11d9ef95fb437f75d07ce768d43e74f158dd54b106e7d3746ce29d545b550'
    ...
    context('feeDelegatedSmartContractExecution.signFeePayerWithKeys', () => {
        const txHash = '0xe9a11d9ef95fb437f75d07ce768d43e74f158dd54b106e7d3746ce29d545b550'
