...
function testAccountKey(
    ...
    const expectedAccountKey = options && options.expectedAccountKey ? options.expectedAccountKey : {}
    const exepectedOptions = options && options.exepectedOptions? options.exepectedOptions : {}
