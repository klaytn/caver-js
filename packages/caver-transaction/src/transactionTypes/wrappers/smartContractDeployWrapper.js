...
const SmartContractDeploy = require('../smartContractDeploy/smartContractDeploy')

/**
 * Represents a smart contract deploy transaction wrapper.
 * @class
 * @hideconstructor
 */
class SmartContractDeployWrapper {
    /**
     * Creates a smart contract deploy transaction wrapper.
    ...
    /**
     * Calls `SmartContractDeploy.create`.
     *
    ...
    /**
     * Calls `SmartContractDeploy.decode`.
     *
     * @param {string} encoded - RLP-encoded string.
     * @return {string} SmartContractDeploy instance.
     */
    decode(encoded) {
        return SmartContractDeploy.decode(encoded, this.klaytnCall)
    }
}

module.exports = SmartContractDeployWrapper
