...
function buildCall() {
  var method = this,
      isSendTx = method.call === 'klay_sendTransaction' || method.call === 'klay_sendRawTransaction' || method.call === 'personal_sendTransaction' || method.call === 'personal_sendValueTransfer' || method.call === 'personal_sendAccountUpdate'
