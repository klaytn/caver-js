 ...
 */
type hexToBytes = (hex: string) => Array<string>
 ...
 * @return {Buffer}
 */
type toBuffer = (input: Buffer | Array<string> | string | number | BN | object) => Buffer
 ...
 * @return {Array} the byte array
 */
const hexToBytes: (hex: string) => Array<string>
 ...
 * @return {Buffer}
 */
const toBuffer: (input: Buffer | Array<string> | string | number | BN | object) => Buffer
